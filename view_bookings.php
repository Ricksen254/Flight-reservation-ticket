...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Header */
    header { background: #003366; padding: 20px; text-align: center; color: #fff; position: sticky; top: 0; z-index:10; }
    header h1 { font-size: 24px; }

    /* Navigation */
    nav { background: #005080; display: flex; justify-content: center; padding: 10px 0; }
    nav a { color: #fff; text-decoration: none; margin: 0 15px; font-size: 16px; transition: background 0.3s; padding: 8px; border-radius:4px; }
    nav a:hover { background: #0074b4; }
    ...
    tr:hover td { background: #e0f0ff; }

    /* Action Buttons */
    .btn { padding: 6px 12px; border: none; border-radius: 4px; color: #fff; font-size: 14px; cursor: pointer; transition: opacity 0.3s; }
    ...
    /* Footer */
    footer { background: #003366; color: #fff; text-align: center; padding: 15px; margin-top: 30px; }
  </style>
</head>
<body>

  <header>
    <h1>Ricksen Flights - Admin Dashboard</h1>
  </header>
  ...
  <div class="container">
    ...
    <table>
      <thead>
        <tr>
          <th>ID</th><th>User ID</th><th>Flight ID</th><th>Seat ID</th>
          <th>Name</th><th>Email</th><th>Phone</th><th>Passport</th>
          <th>Payment</th><th>Created At</th><th>Status</th><th>Actions</th>
        </tr>
      </thead>
      <tbody>
